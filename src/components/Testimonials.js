...
const Testimonials = (props) => {
  ...
  return (
    <div className='w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 '>
      ...
      <div className='text-3xl mt-5 gap-3 text-violet-400 font-bold'>
        <button onClick={leftShiftHandler} className='cursor-pointer '><FiChevronLeft/></button>
        <button onClick={rightShiftHandler} className='cursor-pointer '><FiChevronRight/></button>
      </div>
      <div>
